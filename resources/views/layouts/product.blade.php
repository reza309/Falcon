                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 col-md-10">
                        <div class="menu-container pt-3 mb-3 p-lg-0 p-3 p-md-0">
                            ...
                            <a class="menu-item menue-sm me-3 mb-3 active" href="{{route('home.products')}}">Products</a>
                            ...
                            <a class="menu-item menue-sm me-3 me-md-0 mb-3 support text-decoration-none" href="{{route('product.cart')}}">
                                <small>
