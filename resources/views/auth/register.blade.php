<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" style="z-index: 1; position: relative;" class="p-5 rounded frm-login">
        <x-jet-validation-errors class="mb-4" />
            @csrf

            <div>
                <x-jet-label for="name" value="{{ __('Name') }}" class="text-white-50"/>
            ...
            <div class="mt-4">
                <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}" class="text-white-50"/>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-jet-button class="ml-4 btn-custom border-0">
                    {{ __('Register') }}
                </x-jet-button>
            </div>
        </form>
