        ...
        <div class="container pb-4">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4 col-md-6 mb-md-3">
                    <div class="grid">
                        <div class="grid-inner">
                            <img class="img-fluid" src="<?php echo e(asset('images/systems/e-commerce-tamplate.jpeg')); ?>" alt="template">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="grid">
                        <div class="grid-inner">
                            <img class="img-fluid" src="<?php echo e(asset('images/systems/bg.png')); ?>" alt="template">
                        </div>
